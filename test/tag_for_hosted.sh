...
docker tag gcr.io/ml-pipeline/minio:latest gcr.io/$PROJECT_ID/hosted/$COMMIT_SHA/minio:$SEM_VER
docker tag gcr.io/ml-pipeline/minio:latest gcr.io/$PROJECT_ID/hosted/$COMMIT_SHA/minio:$MM_VER
